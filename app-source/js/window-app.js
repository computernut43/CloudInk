...
module.exports.openWindow = function() {
	...
	// Enable remote module for this window BEFORE loading content
...
ipcMain.on('close-login-modal-request', (event, message) => {
	
	console.log('DEBUG: Received close-login-modal-request from login window')
	win.webContents.send('close-login-modal', 'close-login-modal')
})
