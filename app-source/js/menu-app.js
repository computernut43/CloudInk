			...
			submenu: [
				...
				},
				{
					...
					click (item, focusedWindow) { 
						console.log('DEBUG: Login menu clicked')
						if(focusedWindow) {
							console.log('DEBUG: Sending open-login-modal IPC message')
							focusedWindow.webContents.send('open-login-modal', 'open-login-modal')
						} else {
							console.log('DEBUG: ERROR - No focused window!')
						}
					}
